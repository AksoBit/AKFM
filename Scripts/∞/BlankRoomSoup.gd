...
var RemIS = preload("res://Scenes/RemIS/RemIS.tscn")
var activate = false
...
func _ready() -> void:
	...
	print(RoomInd)
	get_parent().get_node("UwUGG/UwUGG/MusicPlayer").EPICER_MUSIK()
	var Bodies = get_tree().get_nodes_in_group("Bodies") + get_tree().get_nodes_in_group("enemy")
	for node in Bodies:
		node.queue_free()
	if RoomInd == 0:
		...
		NewHack.global_position = Vector2(800 + RoomPos, 0)
		NewHack.get_node("ManHack").activate()
		var NewRemIS = RemIS.instantiate()
		get_parent().add_child(NewRemIS)
		NewRemIS.global_position = Vector2(800 + RoomPos, 100)
		NewHack = Hack.instantiate()
		get_parent().add_child(NewHack)
		NewHack.global_position = Vector2(800 + RoomPos, 100)
		NewHack.get_node("ManHack").activate()
		...
		var NewRemIS = RemIS.instantiate()
		get_parent().add_child(NewRemIS)
		NewRemIS.get_node("RemIS").global_position = Vector2(800 + RoomPos, 100)
	elif RoomInd == 8:
		EnemiesCounter = 7
		var NewTechnoZen = TechnoZen.instantiate()
		get_parent().add_child(NewTechnoZen)
		...
		get_parent().add_child(NewRemIS)
		NewRemIS.get_node("RemIS").global_position = Vector2(800 + RoomPos, 100)
		NewRemIS = RemIS.instantiate()
		get_parent().add_child(NewRemIS)
		NewRemIS.get_node("RemIS").global_position = Vector2(800 + RoomPos, 150)
		NewRodger = Rodger.instantiate()
		get_parent().add_child(NewRodger)
		NewRodger.global_position = Vector2(800 + RoomPos, 254)
		NewRodger.get_node("Roach").activate()
	...
	$DoorExit.queue_free()
	Global.BodyCountForLib = 0
	get_parent().get_node("UwUGG/UwUGG/MusicPlayer").calm_down()
	Global.lib_score = RoomInd
